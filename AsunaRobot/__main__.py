...
PM_START_TEXT = """
`Hello` [🧚‍♀️](https://telegra.ph/file/c657cde06a1dc14af5796.jpg) `My name is` *Hinata Shôyô*
...
HELP_STRINGS = """
`Hi.. I'm` [Hinata Shôyô ⚙️]("https://telegra.ph/file/8cab4bb122cf76702b06d.jpg") 
`Click on the buttons below to get documentation about specific modules..`"""


ASUNA_IMG = "https://telegra.ph/file/49a2f0062849c44cd5f21.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @INTERVIER_RRRR\
    ...
    if query.data == "asuna_":
        query.message.edit_text(
            text=""" ❗ I'm *Hinata Shôyô*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [💾Repository](https://github.com/tobio-shoyo/Shoyo-new).
                 \n\nIf you have any question about *Hinata Shôyô*, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..👸 I'm *Hinata Shôyô*
                 \nHere is the [Source Code](https://github.com/tobio-shoyo/Shoyo-new) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
